...
- During each review, point out concrete opportunities for more idiomatic Rust, explain the idiom, and label optional improvements when the existing code is already correct.
